...
- **Multi-SLM Architecture Registry** — 43 architecture strings across 23 model families (Phi, LLaMA, Mistral, Qwen, Gemma, DeepSeek, StarCoder, Falcon, CodeLlama, Cohere Command, InternLM, Yi, Baichuan, ChatGLM, MPT, RWKV, OLMo, Zephyr, Vicuna, BitNet). 22 prompt templates, 22 tokenizer entries. One-liner to add new models.
