...
- **Multi-SLM Architecture Registry** — 55+ architecture strings across 30+ model families (Phi-3/4, LLaMA-2/3, Mistral, Qwen, Gemma/Gemma2, DeepSeek, StarCoder, Falcon, CodeLlama, Cohere Command/Command-R+, InternLM, Yi, Baichuan, ChatGLM, MPT, RWKV, OLMo, Zephyr, Vicuna, Orca, Solar, Alpaca, Nous Hermes, WizardLM, OpenChat, Granite, Nemotron, Saiga, BitNet). 35 prompt templates, 35 tokenizer entries. One-liner to add new models.
