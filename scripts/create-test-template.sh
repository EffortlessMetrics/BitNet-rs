...
print_header() {
    echo
    print_color $BLUE "🧪 BitNet.rs Test Template Generator"
    print_color $BLUE "===================================="
    echo
}
...
print_color $GREEN "✅ Test file created successfully!"
echo
...
echo "• Quick Start Guide: docs/testing/quick-start-guide.md"
echo "• Test Templates: docs/testing/test-templates.md"
echo "• Test Authoring Guide: docs/testing/test-authoring-guide.md"
echo "• Example tests: tests/examples/"
echo
