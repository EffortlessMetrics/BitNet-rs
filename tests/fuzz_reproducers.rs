...
fn test_gguf_parser_crash_1() {
    ...
    let malformed_gguf = [
        ...
        0x98, 0x90, 0x90, 0x90, 0x8e, 0x90, 0x92, 0xff,
        0x6f, 0x6f,
    ];
...
mod quantization_crashes {
    use bitnet_common::{QuantizationType, BitNetTensor, Device};
    ...
    fn test_i2s_quantization_crash_2() {
        let malformed_input = [
            0xd9, 0x2b, 0x0a, 0x33, 0x7e, 0x0a, 0xff, 0x9f,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xd9, 0x0a,
        ];
