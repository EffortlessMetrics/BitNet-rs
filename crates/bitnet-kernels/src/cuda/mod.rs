...
//! - [`warp_primitives`]: Warp-level shuffle, vote, and ballot primitives (Idx/Up/Down/Xor
//!   shuffles, segmented reduce, match_any)
...
pub use warp_primitives::{
    FULL_MASK, ShuffleMode, WARP_SIZE, WarpConfig as WarpPrimitivesConfig,
    warp_ballot as wp_ballot, warp_broadcast as wp_broadcast, warp_match_any,
    warp_prefix_sum as wp_prefix_sum, warp_reduce_max as wp_reduce_max,
    warp_reduce_min as wp_reduce_min, warp_reduce_sum as wp_reduce_sum, warp_segmented_reduce,
    warp_shuffle as wp_shuffle, warp_shuffle_down, warp_shuffle_up, warp_shuffle_xor,
    warp_vote_all, warp_vote_any,
};

#[cfg(any(feature = "gpu", feature = "cuda"))]
pub use warp_primitives::WARP_PRIMITIVES_KERNEL_SRC;
