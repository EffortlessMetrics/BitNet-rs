...
//! - [`texture_memory`]: Texture memory operations for cache-optimized reads (1-D/2-D fetch,
//!   gather, interpolation, convolution, batch lookup)
//!
...
pub use texture_memory::{
    AddressMode, FilterMode, TextureConfig, TextureObject, create_texture_1d, create_texture_2d,
    destroy_texture, texture_batch_lookup, texture_conv2d, texture_fetch_1d, texture_fetch_2d,
    texture_gather, texture_interpolate,
};

#[cfg(any(feature = "gpu", feature = "cuda"))]
pub use texture_memory::{
    TEXTURE_BATCH_LOOKUP_KERNEL_SRC, TEXTURE_CONV2D_KERNEL_SRC, TEXTURE_FETCH_1D_KERNEL_SRC,
    TEXTURE_FETCH_2D_KERNEL_SRC, TEXTURE_GATHER_KERNEL_SRC, TEXTURE_INTERPOLATE_KERNEL_SRC,
    launch_texture_batch_lookup, launch_texture_conv2d, launch_texture_fetch_1d,
    launch_texture_fetch_2d, launch_texture_gather, launch_texture_interpolate,
};
