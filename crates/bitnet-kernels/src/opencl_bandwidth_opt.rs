    ...
    pub fn efficiency(&self) -> f64 {
        match self {
            ...
            Self::Strided(stride) => {
                ...
                let useful_fraction =
                    FLOAT_SIZE as f64 / (*stride as f64 * FLOAT_SIZE as f64).min(CACHE_LINE_64 as f64);
...
impl PrefetchScheduler {
    ...
    pub fn opencl_prefetch_call(&self, ptr_name: &str, offset_expr: &str) -> String {
        ...
        format!(
            "prefetch({ptr_name} + {offset_expr}, {dist_elements});",
        )
    }
}
...
mod tests {
    ...
    fn test_detect_strided() {
        ...
        assert_eq!(
            AccessPatternDetector::detect(&addrs),
    ...
    fn test_detect_single_address() {
        assert_eq!(
            AccessPatternDetector::detect(&[42]),
            MemoryAccessPattern::Sequential
        );
    }
