//! Host system information collection helpers.
...
pub struct SystemInfo {
    ...
    /// CPU model name.
    pub cpu_name: String,
    /// CPU architecture name (e.g., x86_64, aarch64).
    pub arch: String,
    ...
    /// Package version where the collector is invoked.
...
/// Collect system information with caller-provided package version.
#[must_use]
pub fn collect_system_info_with_version(package_version: &str) -> SystemInfo {
    SystemInfo {
        ...
        bitnet_version: package_version.to_owned(),
    }
}
