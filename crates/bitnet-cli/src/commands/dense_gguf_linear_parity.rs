...
fn dense_gguf_one_layer_execution_plan_receipt_json(
    ...
    {
        bail!(
            "dense GGUF one-layer plan must account for CUDA-routable linears, RMSNorm, RoPE, attention-score, attention-softmax, and attention V-mix ops"
        );
    }
...
mod tests {
    ...
    fn dense_gguf_one_layer_plan_receipt_records_strict_cuda_gap() {
        ...
        assert_eq!(receipt["execution_plan"]["selected_route"], "dense_regular_llm_cuda");
        assert_eq!(receipt["execution_plan"]["cuda_dense_regular_llm_ops"], 13);
        ...
        assert_eq!(receipt["gap_audit"]["unsupported_ops_total"], 1);
        ...
        assert_eq!(receipt["gap_audit"]["next_candidate_gap"], "mlp_activation");
