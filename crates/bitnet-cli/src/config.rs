...
impl CliConfig {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        match self.default_device.as_str() {
            "cpu" | "cuda" | "auto" => {}
            _ => anyhow::bail!("Invalid device: {}. Must be one of: cpu, cuda, auto", self.default_device),
        }
        ...
        match self.logging.format.as_str() {
            "pretty" | "json" | "compact" => {}
            _ => anyhow::bail!("Invalid log format: {}. Must be one of: pretty, json, compact", self.logging.format),
        }
