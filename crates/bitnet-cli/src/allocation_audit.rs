//! Process-wide allocation auditing primitives for CLI receipts.
//!
//! This module owns the global allocator wrapper and low-level counters.  The
//! receipt formatting stays in `main.rs`, while this module is responsible only
//! for capturing allocation/deallocation deltas for scoped measurements.
