//! Core API versioning primitives.
//!
//! Provides version parsing, compatibility checks, negotiation results,
//! and helpers for path/header representation.
...
impl ApiVersion {
    ...
    ///
    /// Same major version and `self.minor >= other.minor` means compatible.
    #[must_use]
