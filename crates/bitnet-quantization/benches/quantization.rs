...
use bitnet_quantization::{I2SQuantizer, TL1Quantizer, TL2Quantizer, Quantize, QuantizerTrait};
...
fn bench_quantization_sizes(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("I2S_quantize", size),
            &size,
            |b, _| {
                let quantizer = I2SQuantizer::new();
                b.iter(|| {
                    black_box(quantizer.quantize_tensor(black_box(&tensor)).unwrap())
                })
            },
        );
        ...
        group.bench_with_input(
            BenchmarkId::new("TL1_quantize", size),
            &size,
            |b, _| {
        ...
        group.bench_with_input(
            BenchmarkId::new("TL2_quantize", size),
            &size,
            |b, _| {
...
fn bench_dequantization_sizes(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("I2S_dequantize", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        group.bench_with_input(
            BenchmarkId::new("TL1_dequantize", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        group.bench_with_input(
            BenchmarkId::new("TL2_dequantize", size),
            &size,
            |b, _| {
                b.iter(|| {
...
fn bench_round_trip(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("TL1_round_trip", size),
            &size,
            |b, _| {
                let quantizer = TL1Quantizer::new();
                b.iter(|| {
        ...
        group.bench_with_input(
            BenchmarkId::new("TL2_round_trip", size),
            &size,
            |b, _| {
                let quantizer = TL2Quantizer::new();
                b.iter(|| {
...
fn bench_trait_quantization(c: &mut Criterion) {
    ...
    group.bench_function("tensor_quantize_I2S", |b| {
        b.iter(|| {
            black_box(tensor.quantize(QuantizationType::I2S).unwrap())
        })
    });
    
    group.bench_function("tensor_quantize_TL1", |b| {
        b.iter(|| {
            black_box(tensor.quantize(QuantizationType::TL1).unwrap())
        })
    });
    
    group.bench_function("tensor_quantize_TL2", |b| {
        b.iter(|| {
            black_box(tensor.quantize(QuantizationType::TL2).unwrap())
        })
    });
