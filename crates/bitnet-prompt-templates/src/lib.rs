...
impl TemplateType {
    ...
    pub fn detect(tokenizer_name: Option<&str>, chat_template_jinja: Option<&str>) -> Self {
        ...
        // Priority 3: Fallback ΓÇö no recognisable signature found
