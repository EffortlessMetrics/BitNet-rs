...
mod tests {
    ...
    #[test]
    fn simple_config_metadata_dimensions_override_bitnet_defaults() {
        let data = build_metadata_only_gguf(vec![
    ...
    #[test]
    fn simple_config_non_bitnet_architecture_stays_non_bitnet() {
        let data = build_metadata_only_gguf(vec![
    ...
    #[test]
    fn simple_config_missing_architecture_keeps_default_semantics() {
        let data = build_metadata_only_gguf(vec![
            (
                "tokenizer.ggml.tokens",
                GgufValue::Array(vec![
