...
//! OpenCL backend utilities for Intel GPU support in BitNet.
//!
//! Provides OpenCL-specific memory management and optimization
//! primitives targeting Intel Arc GPUs.
