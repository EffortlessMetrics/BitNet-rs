//! `bitnet-dispatch-core` — backend-agnostic compute dispatch primitives.
//!
//! This crate centralizes reusable dispatch math and lightweight diagnostics
//! helpers so GPU backends can share one implementation.
