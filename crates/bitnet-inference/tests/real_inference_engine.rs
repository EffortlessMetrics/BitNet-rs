...
#[test]
#[cfg(all(feature = "inference", feature = "crossval", any()))]
...
#[test]
#[cfg(all(feature = "inference", feature = "gpu", any()))]
...
fn validate_throughput_metrics(
    ...
    const MAX_REASONABLE_THROUGHPUT: f64 = 10000.0;
