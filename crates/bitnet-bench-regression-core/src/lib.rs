...
mod tests {
    ...
    #[test]
    fn exact_threshold_is_not_regression() {
        let baseline = vec![receipt("k", 1000)];
    ...
    #[test]
    fn change_pct_negative_for_improvement() {
        let baseline = vec![receipt("k", 1000)];
