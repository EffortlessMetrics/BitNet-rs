...
"#;
    ...
    unsafe { unsafe { env::set_var("BITNET_TEMPERATURE", "0.9"); } }
    unsafe { unsafe { env::set_var("BITNET_USE_GPU", "true"); } }
    ...
    unsafe { unsafe { env::remove_var("BITNET_TEMPERATURE"); } }
    unsafe { unsafe { env::remove_var("BITNET_USE_GPU"); } }
}
