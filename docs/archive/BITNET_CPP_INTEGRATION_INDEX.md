...
**File:** BITNET_CPP_INTEGRATION_ANALYSIS.md § 1
...
### 2. FFI Architecture
**File:** BITNET_CPP_INTEGRATION_ANALYSIS.md § 2
...
**File:** BITNET_CPP_INTEGRATION_ANALYSIS.md § 3 & BITNET_CPP_QUICK_REFERENCE.md
...
### 4. Build Integration
**File:** BITNET_CPP_INTEGRATION_ANALYSIS.md § 4
...
### 5. API Reference
**File:** BITNET_CPP_INTEGRATION_ANALYSIS.md § 6 & BITNET_CPP_QUICK_REFERENCE.md
...
### 6. Tokenizer Parity
**File:** BITNET_CPP_INTEGRATION_ANALYSIS.md § 5
...
**File:** BITNET_CPP_INTEGRATION_ANALYSIS.md § 7
...
**File:** BITNET_CPP_INTEGRATION_ANALYSIS.md § 8
...
See: BITNET_CPP_QUICK_REFERENCE.md § Cross-Validation Testing
...
See: BITNET_CPP_QUICK_REFERENCE.md § Core APIs
...
See: BITNET_CPP_INTEGRATION_ANALYSIS.md § 4
...
See: BITNET_CPP_QUICK_REFERENCE.md § Logits Extraction
...
### ❌ Not Available (llama.cpp Limitation)
...
See: BITNET_CPP_QUICK_REFERENCE.md § Troubleshooting
...
**Checklist:**
1. ✓ Same model file used on both sides
2. ✓ Deterministic settings: `OMP_NUM_THREADS=1`, `GGML_NUM_THREADS=1`
3. ✓ Same tokenization settings
4. ✓ Greedy sampling (no randomness)

See: BITNET_CPP_INTEGRATION_ANALYSIS.md § 3
...
- `CLAUDE.md` § Cross-Validation - Project-level cross-validation guidance
...
1. **Modify C API** → Update `bitnet_c.h`
2. **Modify C++ Shim** → Update `bitnet_c_shim.cc`
3. **Rebuild bindings** → Run `cargo build --features ffi` (automatic)
4. **Add Rust wrapper** → Update `wrapper.rs` with safe abstractions
5. **Test thoroughly** → Add tests in `crossval/tests/`
6. **Update docs** → Revise this documentation
