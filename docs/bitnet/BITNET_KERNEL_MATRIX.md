...
| `qk256` | `qk256-avx512-f32-gemv` | AVX-512 no-scale F32 decode smoke GEMV |
| `qk256` | `qk256-avx512-i8s-scaled-gemv` | AVX-512 BitNet inline-scale I2_S-by-I8_S decode GEMV |
| `qk256` | `qk256-avx512-i8s-scaled-gemm` | AVX-512 BitNet inline-scale I2_S-by-I8_S prefill GEMM |
...
detection, AVX-512 dispatch, AVX-512 execution, AVX-512 speed, and sustained
AVX-512 behavior are separate proof states.
