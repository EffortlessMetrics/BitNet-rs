...
- **Total Enabled Tests**: 3,485 (all pass)
- **Passing Tests**: 3,485 (100%)
...
- ✅ **Property Tests**: 35 test files across 35 proptest crates (209+ properties, proptest)
...
| **Property Tests** | 209+ | ✅ Passing | Randomised invariants (proptest, 35 test files) |
...
- **Property-based tests**: Randomised invariant checks (proptest, 35 test files, 209+ properties)
...
BitNet.rs has 13 fuzz targets covering parsers, kernels, tokenizers, logits transforms, and generation stopping. Fuzz targets run nightly via `.github/workflows/fuzz-ci.yml` (60 seconds per target, `01:00 UTC`).
