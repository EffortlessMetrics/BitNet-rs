...
This release achieves **deterministic CPU parity** with Microsoft's BitNet C++ reference implementation through a pure-Rust GGUF tokenizer with proper ByteLevel BPE handling and comprehensive receipt-based provenance tracking.
