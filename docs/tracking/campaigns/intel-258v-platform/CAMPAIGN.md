...
| CPU-BITNET-EMBD-001 | in_progress | Record 258V BitNet embedding quantization evidence from the committed tensor-boundary audit, including current F16 embedding state and explicit Q6_K-not-active boundary unless a Q6_K embedding artifact is present. |
