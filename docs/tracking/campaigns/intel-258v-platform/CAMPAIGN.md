...
| CPU258V-018 | ready | Compare official HF `AutoTokenizer.apply_chat_template` rendered prompts and token IDs against BitNet-rs metadata-authoritative prompt-authority audit output for fixed 258V prompts; no inference, logits, answer-quality, speed, Arc/NPU, or QK256 claim. |
