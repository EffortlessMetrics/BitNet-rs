...
| CPU258V-019 | pr_open | Capture the external first-token reference boundary from HF or bitnet.cpp for the fixed 258V prompts, recording generated token/text when available and explicit missing-logits status without claiming logits parity; opened in #4248. |
