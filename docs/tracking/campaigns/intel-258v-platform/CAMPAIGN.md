...
| CPU258V-031 | pr_open | Refresh the 258V CPU reference bundle after the prompt-policy fix, answer-corpus pass, scalar/AVX2 parity, and corrected warm-session phase receipts without new runtime or accelerator claims; opened in #4523. |
