...
| LNL258V-COMPARE-002 | pr_open | Refresh the same-machine evidence index after the post-mechanics CPU reference bundle, NPU selected subgraph receipts, and Arc 140V native OpenCL parity; opened in #4110. |
