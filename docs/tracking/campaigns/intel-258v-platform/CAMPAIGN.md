...
| ARC140V-005 | pr_open | Add native OpenCL CPU/iGPU parity for one isolated Arc 140V kernel against the 258V CPU reference bundle; opened in #4103; no BitNet/QK256/acceleration claims. |
