...
| CPU-BITNET-PERF-003 | pr_open | #4689 records a 258V QK256/I2_S applied-thread microbench receipt with scoped row-partitioned GEMV and token-partitioned GEMM samples, fallback=false, speedup_claim=false, and no full-runtime worker-policy claim. |
