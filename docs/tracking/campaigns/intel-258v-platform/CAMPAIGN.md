...
| SLM-OV258V-006 | pr_open | Add a Qwen2.5 OpenVINO GenAI phase runner for CPU, GPU.0/Arc 140V, and NPU PerfMetrics plus first streamed text chunk timing; open in #4594. |
