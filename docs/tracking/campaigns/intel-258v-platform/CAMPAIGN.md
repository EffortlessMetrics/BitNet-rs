...
| CPU258V-019 | ready | Capture the external first-token reference boundary from HF or bitnet.cpp for the fixed 258V prompts, recording generated token/text when available and explicit missing-logits status without claiming logits parity. |
