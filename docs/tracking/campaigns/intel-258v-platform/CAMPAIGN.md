...
| CPU-BITNET-PERF-002 | merged | Recorded a 258V QK256/I2_S tiling/thread candidate matrix with sampled GEMV/GEMM timings, fallback=false, speedup_claim=false, and explicit thread-count-not-applied status in #4609. No answer-quality, sustained-throughput, Arc/NPU, acceleration, QK256 semantic-change, or full-model claims. |
