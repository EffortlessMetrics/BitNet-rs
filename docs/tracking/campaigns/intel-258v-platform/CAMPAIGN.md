...
| CPU-BITNET-PERF-001 | in_progress | Record 258V QK256/I2_S GEMV and GEMM microbench timing receipts with fallback=false and speedup_claim=false; no answer-quality, sustained-throughput, Arc/NPU, acceleration, QK256 semantic-change, or full-model claims. |
