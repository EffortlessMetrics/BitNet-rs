...
| CPU-BITNET-REF-002 | pr_open | Harden the first-token divergence classifier so future direct BitNet.cpp generated-token evidence is consumed as token evidence instead of falling through to an unknown summary; open in #4710. |
