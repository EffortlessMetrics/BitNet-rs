...
| ARC140V-005 | ready | Add native OpenCL CPU/iGPU parity for one isolated Arc 140V kernel against the 258V CPU reference bundle; no BitNet/QK256/acceleration claims. |
