...
| CPU258V-029 | pr_open | Rerun scalar and AVX2 BitNet answer-corpus receipts after the prompt-policy fix and classify any remaining tiny-corpus failures without broad answer-quality, speed, Arc/NPU, or QK256 claims; open in #4516. |
