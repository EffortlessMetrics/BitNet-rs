...
| LNL258V-ASK-004 | pr_open | Add an explicit OpenVINO GenAI operator-ask helper for dense Qwen GPU/NPU candidate routes, recording bounded answer receipts with fallback=false and no acceleration or speedup claim; open in #4712. |
