...
| M4-DURABLE-002 | pr_open | PR #4988 refreshes dense SLM benchmark reports for every supported M4 model, including `resident_100`; strict regression against the previous baseline is blocked by the expected profile-set mismatch. |
