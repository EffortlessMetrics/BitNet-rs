...
| CUDA-MODEL-001 | pr_open | PR #4836 adds the Qwen3 0.6B artifact contract as the first generalized dense model onboarding item without promoting CPU, CUDA, speed, server, or BitNet claims. |
