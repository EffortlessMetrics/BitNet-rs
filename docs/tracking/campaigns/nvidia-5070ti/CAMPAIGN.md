...
| CUDA-MODEL-008 | in_progress | Sync Qwen3 0.6B model coverage and model-status output to the exact earned accelerator-ready candidate tier after CUDA-MODEL-007, without promoting product CLI, speed, server, full-residency, broad dense GGUF, or BitNet QK256 claims. |
