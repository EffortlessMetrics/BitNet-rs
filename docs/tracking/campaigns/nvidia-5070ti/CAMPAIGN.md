...
| CUDA-MODEL-011 | pr_open | PR #5645 records the Qwen3 0.6B normal `bitnet chat` user-path receipt with model/tokenizer/CUDA context/weights loaded once across multiple prompts while keeping product, server, speedup, full-residency, broad dense GGUF, and BitNet QK256 claims false. |
