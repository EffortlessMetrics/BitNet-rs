...
| Qwen3 0.6B | candidate with artifact, CPU sanity, all-layer plan, one-token strict CUDA proof, bounded short-decode strict CUDA proof, warm-session strict CUDA proof, and benchmark qualification review in progress | `ci/hardware/windows-9950x3d-rtx5070ti/2026-05-15/qwen3-0_6b-benchmark-qualification.json` | repeated comparator evidence or exact earned-tier status promotion |
