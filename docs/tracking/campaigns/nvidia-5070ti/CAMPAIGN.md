...
| Qwen3 0.6B | candidate with artifact, CPU sanity, all-layer plan, one-token strict CUDA proof, and bounded short-decode strict CUDA proof | `ci/hardware/windows-9950x3d-rtx5070ti/2026-05-15/qwen3-0_6b-short-decode-cuda.json` | warm-session strict CUDA proof |
