...
| CUDA-DENSE-005 | in_progress | Dense regular-LLM CUDA fixture receipts carry a model-aware `dense_regular_llm_cuda` execution plan while remaining rejected as BitNet packed I2_S/QK256 proof. |
