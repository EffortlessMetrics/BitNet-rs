...
| RTX5070TI-008 | pr_open | #3770 | `codex/nvidia-5070ti/RTX5070TI-008-benchmark-baseline` | Benchmark parity-tested RTX 5070 Ti CUDA kernels/subgraphs against the 9950X3D CPU reference with driver/runtime/VRAM/power/thermal context and no full inference or unproven speedup claim. |
