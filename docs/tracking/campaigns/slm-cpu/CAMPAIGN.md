...
| SLM-CPU-017 | ready | Next bounded item: second small dense GGUF model sanity check using verified metadata, strict tokenizer authority, selected CPU backend, and fallback=false; no Q4/Q5, accelerator, server, Qwen3.5, throughput, or BitNet QK256 claim. |
