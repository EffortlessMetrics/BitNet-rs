...
| SLM-CPU-054 | pr_open | #5992 records the remaining packed Q8_0 sidecar runtime hook/API gap while keeping eager F32 Candle as the default behavior oracle and sidecar_runtime_compute_allowed=false. |
