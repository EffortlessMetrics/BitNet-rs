...
| SLM-CPU-008Z | ready | Fix or further localize the Qwen3 first required-stage drift at `attention.q_proj` before any first-token parity, corpus, or performance claim. |
