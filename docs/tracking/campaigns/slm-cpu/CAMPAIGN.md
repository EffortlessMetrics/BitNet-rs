...
| SLM-CPU-006 | pr_open | #4071 captures a real i5-8250U bitnet-rs first-token top-k run and reference-divergence validation for Qwen3-0.6B without answer-quality or throughput claims. |
