...
| SLM-CPU-042 | in_progress | Start the next dense-math performance slice by identifying and instrumenting the first behavior-preserving Q8_0 dense linear locality or matmul/dequant boundary after the Candle output-storage API blocker. |
