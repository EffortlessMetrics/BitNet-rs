...
| SLM-CPU-050 | ready | Add the production-compute-hook availability surface while keeping eager F32 Candle selected until later behavior-preserving selector evidence exists. |
