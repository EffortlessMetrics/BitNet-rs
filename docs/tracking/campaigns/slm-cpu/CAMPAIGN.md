...
| SLM-CPU-017 | pr_open | #5058 records bounded Qwen2.5-0.5B Q8_0 second-model sanity evidence on the strict i5-8250U CPU path; no broad quality, sustained throughput, Q4/Q5, accelerator, server, Qwen3.5, or BitNet QK256 claim. |
