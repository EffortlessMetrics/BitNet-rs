...
| M4-SLM-HARDEN-002 | pr_open | #4155 | `codex/apple-m4-slm-hardening/M4-SLM-HARDEN-002-cache-repair` | `codex_premerge` | `automerge_when_green` | `on_blocker_only` | Improve first-run, corrupted-cache, low-disk, offline, verify, and prune guidance for Mac SLM operators without changing model artifacts or backend claims. |
