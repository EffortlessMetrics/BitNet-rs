...
|---|---|---|
| M4-CONT-001 | in_progress | Add resident `bitnet mac chat` wrapper over the supported dense SLM warm-session runner. |
| M4-CONT-002 | proposed | Add compact M4 dense-SLM golden smoke command. |
