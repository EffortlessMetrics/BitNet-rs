...
| M4-SLM-EX-005 | in_progress | Document dense model support matrix for default and leading candidate SLMs: default, supported, candidate, diagnostic-only, and rejected model states. |
