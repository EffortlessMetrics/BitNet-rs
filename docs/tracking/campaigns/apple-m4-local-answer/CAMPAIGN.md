...
| M4-BITNET-ASK-006 | pr_open | #4691 adds `bitnet mac smoke --model-family bitnet` as a one-shot BitNet ask smoke with accepted model/tokenizer identity, failure receipts, and unchanged chat/server/Metal boundaries. |
