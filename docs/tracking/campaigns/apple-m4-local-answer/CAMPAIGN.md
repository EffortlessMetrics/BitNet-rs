...
| M4-BITNET-WARM-002 | in_progress | Surface the merged BitNet fixed-prompt warm route in `bitnet mac models`, `bitnet mac doctor`, and local-server `/models` catalog readiness without enabling BitNet chat/server/Metal boundaries. |
