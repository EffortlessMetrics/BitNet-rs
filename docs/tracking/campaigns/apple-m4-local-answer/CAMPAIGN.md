...
| M4-BITNET-ASK-005 | in_progress | Add advisory BitNet one-shot ask readiness to `bitnet mac doctor` receipts without making dense doctor fail when optional BitNet artifacts are absent or enabling BitNet chat/server/Metal claims. |
