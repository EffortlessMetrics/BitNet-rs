...
|---|---|---|
| M4-EXCELLENCE-001 | in_progress | Add a second dense SLM eval-v2 refresh so dense eval groups can become comparable. |
| M4-EXCELLENCE-002 | proposed | Add a second BitNet variable warm refresh so the warm group can become comparable. |
