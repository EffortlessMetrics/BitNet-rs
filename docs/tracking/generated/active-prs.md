...
|---|---|---:|---|---|
| apple-m4-slm-answer | SLM-M4-003 | #3948 | `codex/apple-m4-slm-answer/SLM-M4-003-qwen-trace` | Run the validated dense SLM through the Rust CLI with apple-m4-cpu-neon, strict loader/tokenizer behavior, explicit fallback status, coherent answer text, generated token IDs, and timing in receipts. |
