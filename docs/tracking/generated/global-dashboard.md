...
| cpu-proof | CPU-ANSWER-005 | #4003 | pr_open | none | 258V CPU is the lead BitNet CPU reference; no GPU or NPU claims. |
...
| intel-258v-platform | CPU258V-005 | #3999 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
