...
| apple-m4-slm-performance | M4-SLM-PERF-001 | TBD | in_progress | M4-SLM-PERF-002 | Do not reopen the completed apple-m4, apple-m4-operational, apple-m4-slm-answer, or apple-m4-productization campaigns. |
...
| intel-258v-platform | CPU258V-014 | #4041 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
