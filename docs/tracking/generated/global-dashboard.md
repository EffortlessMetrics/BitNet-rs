...
| intel-258v-platform | LNL258V-ROUTE-010 | #5580 | pr_open | LNL258V-OPENVINO-DOCS-001 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
