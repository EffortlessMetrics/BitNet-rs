...
| intel-258v-platform | CPU258V-017 | #4123 | pr_open | CPU258V-018 | 258V CPU input-contract proof is first priority; prompt/token authority must be audited before more Arc, NPU, or SIMD work. |
