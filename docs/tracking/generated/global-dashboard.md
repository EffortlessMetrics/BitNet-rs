...
| apple-m4-slm-model-breadth | M4-MODEL-001 | #4339 | in_progress | M4-MODEL-002 | This is an M4 Mac mini dense SLM campaign. |
...
| intel-258v-platform | CPU258V-024 | TBD | ready | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-037 | #4333 | pr_open | none | CUDA visibility is not kernel execution. |
