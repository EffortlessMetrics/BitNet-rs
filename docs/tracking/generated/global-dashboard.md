...
| cpu-proof | CPU-ANSWER-002 | #3906 | pr_open | none | 258V CPU is the lead BitNet CPU reference; no GPU or NPU claims. |
...
| slm-cpu | SLM-CPU-002A | TBD | in_progress | SLM-CPU-003 | Do not edit BitNet QK256/I2_S kernels. |
