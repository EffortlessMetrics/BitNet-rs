...
| intel-258v-platform | LNL258V-COMPARE-002 | #4110 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-BITNET-PERF-003 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
