...
| apple-m4-slm-performance | M4-SLM-PERF-007 | TBD | in_progress | none | Do not reopen the completed apple-m4, apple-m4-operational, apple-m4-slm-answer, or apple-m4-productization campaigns. |
...
| nvidia-5070ti | CUDA-PROD-004 | TBD | ready | CUDA-DENSE-001 | CUDA visibility is not kernel execution. |
