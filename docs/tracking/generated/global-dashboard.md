...
| apple-m4-slm-excellence | M4-SLM-EX-007 | TBD | ready | M4-SLM-EX-008 | This is an M4 Mac mini local campaign. |
...
| nvidia-5070ti | CUDA-DENSE-028 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
