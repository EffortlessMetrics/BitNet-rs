...
| apple-m4-slm-model-breadth | M4-MODEL-003 | #4355 | pr_open | M4-MODEL-004 | This is an M4 Mac mini dense SLM campaign. |
...
| intel-258v-platform | CPU258V-025 | TBD | ready | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
