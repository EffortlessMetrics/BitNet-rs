...
| intel-258v-platform | LNL258V-GOAL-AUDIT-006 | TBD | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-058 | #6070 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
