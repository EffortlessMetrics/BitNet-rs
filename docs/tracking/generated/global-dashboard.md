...
| apple-m4-inference-excellence | M4-REPRO-002 | #5528 | pr_open | M4-REPRO-003 | This is an M4 Mac mini inference-excellence campaign. |
...
| cpu-proof | CPU-SCALAR-000 | TBD | in_progress | none | 258V CPU is the lead BitNet CPU reference; no GPU or NPU claims. |
