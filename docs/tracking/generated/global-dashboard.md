...
| intel-258v-platform | LNL258V-REG-001 | #4624 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-008U | #4617 | merged | none | Do not edit BitNet QK256/I2_S kernels. |
