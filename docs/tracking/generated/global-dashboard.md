...
| intel-258v-platform | LNL258V-OP-011 | #5986 | ready | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-054 | #5983 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
