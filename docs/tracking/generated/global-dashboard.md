...
| apple-m4-durable-inference-evidence | M4-DURABLE-002 | #4988 | pr_open | M4-DURABLE-003 | This is an M4 Mac mini evidence-refresh campaign. |
...
| nvidia-5070ti | CUDA-MODEL-007 | #4996 | pr_open | none | CUDA visibility is not kernel execution. |
