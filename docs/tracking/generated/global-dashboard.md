...
| apple-m4-local-server | M4-SERVE-002 | TBD | in_progress | M4-SERVE-003 | This is an M4 Mac mini dense SLM service campaign. |
...
| intel-258v-platform | CPU258V-025 | #4356 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
