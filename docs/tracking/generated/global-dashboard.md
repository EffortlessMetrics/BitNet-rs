...
| apple-m4-inference-excellence | M4-REPRO-004 | TBD | in_progress | M4-RECEIPT-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-OPENVINO-DOCS-003 | #5587 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
