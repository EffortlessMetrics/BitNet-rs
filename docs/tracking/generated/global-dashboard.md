...
| apple-m4-local-answer | M4-QA-004 | TBD | proposed | M4-QA-005 | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
...
| intel-258v-platform | LNL258V-REG-001 | #4624 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-PROD-010 | #4616 | pr_open | none | CUDA visibility is not kernel execution. |
| server-real-inference | SERVER-005 | #4490 | merged | none | Do not reintroduce simulated inference. |
| slm-cpu | SLM-CPU-008V | TBD | in_progress | SLM-CPU-008W | Do not edit BitNet QK256/I2_S kernels. |
