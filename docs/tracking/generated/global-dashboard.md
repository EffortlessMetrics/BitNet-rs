...
| intel-258v-platform | LNL258V-GOAL-AUDIT-040 | TBD | in_progress | LNL258V-POWER-013 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
