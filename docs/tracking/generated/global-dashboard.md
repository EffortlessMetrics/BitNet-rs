...
| apple-m4-continuity | M4-CONT-005 | TBD | blocked | none | This is an M4 Mac mini local campaign; do not execute MacBook artifact sweeps or MacBook receipts here. |
...
| nvidia-5070ti | CUDA-DENSE-025 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
