...
| model-artifacts | BITNET-COMPAT-001 | TBD | in_progress | none | Do not weaken CPU, CUDA, Apple, NPU, SLM, server, or quality gates. |
...
| slm-cpu | SLM-CPU-007 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
