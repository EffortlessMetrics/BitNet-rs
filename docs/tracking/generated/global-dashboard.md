...
| apple-m4-inference-excellence | M4-CANARY-001 | TBD | in_progress | M4-DENSE-REF-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-OPENVINO-DOCS-001 | TBD | ready | LNL258V-OPENVINO-DOCS-002 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
