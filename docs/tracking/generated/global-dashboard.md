...
| intel-258v-platform | SLM-OV258V-002 | #4565 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-008R | TBD | in_progress | none | Do not edit BitNet QK256/I2_S kernels. |
