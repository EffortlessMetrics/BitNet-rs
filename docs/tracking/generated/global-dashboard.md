...
| apple-m4-durable-inference-evidence | M4-DURABLE-003 | TBD | proposed | M4-DURABLE-004 | This is an M4 Mac mini evidence-refresh campaign. |
...
| nvidia-5070ti | CUDA-MODEL-008 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
