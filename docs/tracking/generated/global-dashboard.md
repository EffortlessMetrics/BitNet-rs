...
| apple-m4-inference-excellence | M4-BENCH-007 | #5869 | pr_open | M4-ROUTE-MATRIX-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-PROFILE-RUN-003 | #5874 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-048 | #5873 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
