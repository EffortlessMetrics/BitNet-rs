...
| intel-258v-platform | SLM-OV258V-002A | #4571 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-PROD-008 | TBD | ready | CUDA-DENSE-050 | CUDA visibility is not kernel execution. |
| server-real-inference | SERVER-005 | #4490 | merged | none | Do not reintroduce simulated inference. |
| slm-cpu | SLM-CPU-008S | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
