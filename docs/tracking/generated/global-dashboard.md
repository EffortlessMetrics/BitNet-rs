...
| apple-m4-inference-excellence | M4-BITNET-EX-013 | TBD | in_progress | M4-BITNET-EX-014 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-OPENVINO-QUAL-RERUN-002 | #5669 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-040 | #5715 | pr_open | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
