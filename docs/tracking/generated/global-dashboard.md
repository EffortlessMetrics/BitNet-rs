...
| apple-m4-operational | M4-OP-003 | TBD | in_progress | M4-OP-004 | Do not reopen the completed apple-m4 proof campaign. |
...
| intel-npu | NPU-005 | TBD | in_progress | none | Device-node detection is not inference. |
