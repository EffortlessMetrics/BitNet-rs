...
| apple-m4-inference-excellence | M4-DENSE-CHAT-001 | TBD | proposed | M4-ROBUSTNESS-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-npu | NPU-012 | #5634 | pr_open | none | Device-node detection is not inference. |
