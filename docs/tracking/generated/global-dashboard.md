...
| apple-m4-slm-performance | M4-SLM-PERF-005 | #4069 | pr_open | M4-SLM-PERF-006 | Do not reopen the completed apple-m4, apple-m4-operational, apple-m4-slm-answer, or apple-m4-productization campaigns. |
...
| nvidia-5070ti | CUDA-PROD-003 | TBD | in_progress | CUDA-DENSE-001 | CUDA visibility is not kernel execution. |
