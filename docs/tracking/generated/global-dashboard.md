...
| apple-m4-slm-performance | M4-SLM-PERF-003 | TBD | ready | M4-SLM-PERF-004 | Do not reopen the completed apple-m4, apple-m4-operational, apple-m4-slm-answer, or apple-m4-productization campaigns. |
...
| nvidia-5070ti | CUDA-PROD-001 | TBD | in_progress | CUDA-DENSE-001 | CUDA visibility is not kernel execution. |
