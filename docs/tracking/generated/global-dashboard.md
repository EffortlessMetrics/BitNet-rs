...
| apple-m4-slm-answer | SLM-M4-004 | TBD | ready | SLM-M4-005 | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
...
| intel-258v-platform | ARC140V-004 | #3953 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-004 | TBD | ready | SLM-CPU-005 | Do not edit BitNet QK256/I2_S kernels. |
