...
| intel-258v-platform | LNL258V-OPENVINO-VALIDATE-001 | #5614 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-035 | TBD | in_progress | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
