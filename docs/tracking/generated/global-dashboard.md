...
| intel-258v-platform | CPU-BITNET-PERF-002 | #4609 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-008T | #4611 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
