...
| intel-258v-platform | ARC140V-005 | #4103 | pr_open | LNL258V-COMPARE-002 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-BITNET-PERF-002 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
