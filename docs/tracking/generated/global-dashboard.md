...
| apple-m4-inference-excellence | M4-METAL-EX-001 | #6194 | pr_open | M4-METAL-EX-002 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-GOAL-AUDIT-027 | #316 | pr_open | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-024 | #314 | pr_open | none | OpenCL-first for native A770 proof. |
...
| nvidia-5070ti | CUDA-MODEL-017 | TBD | ready | CUDA-MODEL-018 | CUDA visibility is not kernel execution. |
...
| slm-cpu | SLM-CPU-080 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
