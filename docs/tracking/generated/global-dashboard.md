...
| nvidia-5070ti | CUDA-PLANNER-004 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
| server-real-inference | SERVER-001 | TBD | proposed | none | Do not reintroduce simulated inference. |
| slm-cpu | SLM-CPU-007B | #4138 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
