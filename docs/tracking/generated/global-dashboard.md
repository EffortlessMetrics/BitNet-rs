...
| apple-m4-inference-excellence | M4-STABILITY-002 | TBD | proposed | M4-STABILITY-003 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-LOWPOWER-QUAL-001 | TBD | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-044 | #5810 | pr_open | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
