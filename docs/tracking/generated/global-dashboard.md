...
| apple-m4-local-server | M4-SERVE-004 | TBD | in_progress | M4-SERVE-005 | This is an M4 Mac mini dense SLM service campaign. |
...
| intel-258v-platform | CPU258V-026 | #4365 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-040 | #4370 | pr_open | none | CUDA visibility is not kernel execution. |
