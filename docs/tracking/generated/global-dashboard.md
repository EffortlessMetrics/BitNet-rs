...
| apple-m4-slm-model-breadth | M4-MODEL-006 | TBD | in_progress | M4-MODEL-007 | This is an M4 Mac mini dense SLM campaign. |
...
| nvidia-5070ti | CUDA-DENSE-042 | #4392 | pr_open | none | CUDA visibility is not kernel execution. |
