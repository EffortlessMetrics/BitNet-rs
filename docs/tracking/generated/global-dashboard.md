...
| apple-m4-inference-excellence | M4-BENCH-005 | TBD | proposed | M4-BENCH-006 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-GOAL-AUDIT-002 | #6017 | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
