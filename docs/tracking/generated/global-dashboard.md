...
| nvidia-5070ti | CUDA-MODEL-002 | TBD | in_progress | CUDA-MODEL-003 | CUDA visibility is not kernel execution. |
| server-real-inference | SERVER-005 | #4490 | merged | none | Do not reintroduce simulated inference. |
| slm-cpu | SLM-CPU-011 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
