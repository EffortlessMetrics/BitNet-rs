...
| intel-258v-platform | LNL258V-INTELGPU-DOCS-001 | TBD | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-INTELGPU-DOCS-001 | TBD | in_progress | none | OpenCL-first for native A770 proof. |
