...
| apple-m4-slm-answer | SLM-M4-007 | TBD | ready | none | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
| ci-coverage | CI-COVERAGE-001 | #3620 | merged | none | Do not block unrelated runtime or tracker work on optional coverage uploads. |
| cpu-proof | CPU-ANSWER-003 | TBD | ready | none | 258V CPU is the lead BitNet CPU reference; no GPU or NPU claims. |
...
| intel-258v-platform | CPU258V-004 | #3981 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| model-artifacts | MODEL-ARTIFACT-007 | #3988 | pr_open | none | Do not weaken CPU, CUDA, Apple, NPU, SLM, server, or quality gates. |
...
| slm-cpu | SLM-CPU-005 | #3969 | merged | none | Do not edit BitNet QK256/I2_S kernels. |
