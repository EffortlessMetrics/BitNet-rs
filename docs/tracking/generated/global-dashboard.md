...
| intel-258v-platform | LNL258V-BITNET-INTAKE-001 | TBD | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-043 | TBD | ready | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
