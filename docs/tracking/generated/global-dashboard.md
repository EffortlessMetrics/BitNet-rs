...
| apple-m4-productization | M4-PROD-002 | TBD | in_progress | M4-PROD-003 | Do not reopen the completed apple-m4, apple-m4-operational, or apple-m4-slm-answer campaigns. |
...
| cpu-proof | CPU-ANSWER-006 | #4005 | pr_open | none | 258V CPU is the lead BitNet CPU reference; no GPU or NPU claims. |
