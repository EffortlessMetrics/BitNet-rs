...
| intel-258v-platform | LNL258V-POWER-005 | #5924 | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-003 | TBD | proposed | A770-004 | OpenCL-first for native A770 proof. |
| intel-npu | NPU-013 | TBD | ready | none | Device-node detection is not inference. |
...
| slm-cpu | SLM-CPU-052 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
