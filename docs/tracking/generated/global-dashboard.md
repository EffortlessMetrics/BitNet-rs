...
| apple-m4-inference-excellence | M4-SETUP-001 | TBD | proposed | M4-BENCH-007 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-EXCELLENCE-AUDIT-001 | #5858 | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-045 | #5845 | pr_open | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
