...
| apple-m4-continuity | M4-CONT-004 | TBD | in_progress | M4-CONT-005 | This is an M4 Mac mini local campaign; do not execute MacBook artifact sweeps or MacBook receipts here. |
...
| nvidia-5070ti | CUDA-DENSE-024 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
