...
| apple-m4-inference-excellence | M4-BITNET-EX-010 | TBD | proposed | M4-BITNET-EX-011 | This is an M4 Mac mini inference-excellence campaign. |
...
| nvidia-5070ti | CUDA-SERVER-004 | TBD | proposed | CUDA-SERVER-005 | CUDA visibility is not kernel execution. |
