...
| apple-m4-bitnet-productization | M4-BITNET-PROD-003 | TBD | in_progress | M4-BITNET-PROD-004 | This is an M4 Mac mini BitNet campaign. |
...
| nvidia-5070ti | CUDA-MODEL-004 | #4940 | pr_open | CUDA-MODEL-005 | CUDA visibility is not kernel execution. |
