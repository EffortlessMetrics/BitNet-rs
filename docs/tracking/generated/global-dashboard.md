...
| intel-258v-platform | CPU258V-023 | TBD | ready | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-036 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
