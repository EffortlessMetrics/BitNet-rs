...
| apple-m4-operational | M4-OP-004 | TBD | proposed | M4-OP-006 | Do not reopen the completed apple-m4 proof campaign. |
| ci-coverage | CI-COVERAGE-001 | #3620 | merged | none | Do not block unrelated runtime or tracker work on optional coverage uploads. |
| cpu-proof | CPU-BITNET-008 | #3856 | merged | none | No GPU or NPU claims. |
...
| intel-npu | NPU-007 | TBD | ready | none | Device-node detection is not inference. |
