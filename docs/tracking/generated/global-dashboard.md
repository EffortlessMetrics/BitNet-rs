...
| apple-m4-slm-hardening | M4-SLM-HARDEN-001 | TBD | in_progress | M4-SLM-HARDEN-002 | Do not reopen completed Apple M4 proof, operational, SLM answer, productization, or performance campaigns. |
...
| nvidia-5070ti | CUDA-PLANNER-004 | #4146 | merged | none | CUDA visibility is not kernel execution. |
