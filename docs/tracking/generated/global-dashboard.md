...
| intel-258v-platform | CPU258V-022 | TBD | ready | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-034 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
