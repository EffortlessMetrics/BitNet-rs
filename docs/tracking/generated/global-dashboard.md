...
| apple-m4-slm-metal-phases | M4-METAL-004 | TBD | blocked | M4-METAL-005 | This is an M4 Mac mini dense SLM campaign. |
...
| nvidia-5070ti | CUDA-DENSE-041 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
