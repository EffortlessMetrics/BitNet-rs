...
| apple-m4-inference-excellence | M4-BENCH-010 | TBD | in_progress | M4-BENCH-006 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-POWER-005 | #5924 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
