...
| apple-m4-dense-slm-regression | M4-SLM-REG-002 | TBD | in_progress | M4-SLM-REG-003 | Do not reopen the completed apple-m4, apple-m4-slm-answer, apple-m4-productization, or apple-m4-slm-performance campaigns. |
...
| nvidia-5070ti | CUDA-DENSE-007 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
