...
| apple-m4-slm-excellence | M4-SLM-EX-008 | #4301 | in_progress | M4-SLM-EX-009 | This is an M4 Mac mini local campaign. |
...
| intel-258v-platform | CPU258V-020 | TBD | ready | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-029 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
