...
| intel-258v-platform | LNL258V-ROUTE-016 | #5774 | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-041 | #5754 | pr_open | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
