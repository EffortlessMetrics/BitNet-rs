...
| apple-m4-inference-excellence | M4-ACCURACY-002 | TBD | proposed | M4-ACCURACY-003 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-QUAL-004 | #5100 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-020 | #5108 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
