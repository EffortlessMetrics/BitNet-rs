...
| apple-m4-inference-excellence | M4-EXCELLENCE-004 | #5089 | pr_open | M4-ACCURACY-000 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-ROUTE-003 | #5071 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-019 | #5081 | pr_open | none | Do not edit BitNet QK256/I2_S kernels. |
