...
| apple-m4-inference-excellence | M4-ACCURACY-005 | #5154 | pr_open | M4-ACCURACY-006 | This is an M4 Mac mini inference-excellence campaign. |
...
| nvidia-5070ti | CUDA-STATUS-001 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
