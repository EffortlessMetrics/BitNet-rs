...
| apple-m4-bitnet-eval-and-benchmark | M4-BITNET-EVAL-002 | TBD | in_progress | M4-BITNET-EVAL-003 | This is an M4 Mac mini BitNet campaign. |
...
| nvidia-5070ti | CUDA-MODEL-003 | TBD | proposed | CUDA-MODEL-004 | CUDA visibility is not kernel execution. |
| server-real-inference | SERVER-005 | #4490 | merged | none | Do not reintroduce simulated inference. |
| slm-cpu | SLM-CPU-014 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
