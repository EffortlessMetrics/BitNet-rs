...
| intel-258v-platform | LNL258V-GOAL-AUDIT-032 | #363 | pr_open | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-027 | #344 | merged | none | OpenCL-first for native A770 proof. |
