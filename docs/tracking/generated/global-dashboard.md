...
| apple-m4-local-answer | M4-BITNET-ASK-002 | #4651 | merged | none | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
...
| intel-258v-platform | LNL258V-ASK-003 | #4668 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
