...
| apple-m4-inference-excellence | M4-BENCH-003 | TBD | proposed | M4-BITNET-EX-015 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-BITNET-INTAKE-003 | #6046 | in_progress | LNL258V-POWER-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-057 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
