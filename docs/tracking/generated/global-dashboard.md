...
| intel-258v-platform | CPU258V-022 | #4321 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-035 | #4328 | pr_open | none | CUDA visibility is not kernel execution. |
