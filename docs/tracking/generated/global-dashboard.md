...
| intel-258v-platform | LNL258V-BENCH-003 | TBD | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
