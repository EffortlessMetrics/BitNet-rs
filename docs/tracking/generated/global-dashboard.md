...
| apple-m4-inference-excellence | M4-WORKLOAD-001 | TBD | in_progress | M4-EVIDENCE-REPLAY-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-a770 | A770-007 | #6113 | merged | none | OpenCL-first for native A770 proof. |
...
| slm-cpu | SLM-CPU-066 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
