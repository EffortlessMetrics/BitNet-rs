...
| apple-m4-local-server | M4-SERVE-003 | TBD | blocked | M4-SERVE-004 | This is an M4 Mac mini dense SLM service campaign. |
...
| intel-258v-platform | CPU258V-026 | TBD | ready | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-039 | #4357 | pr_open | none | CUDA visibility is not kernel execution. |
