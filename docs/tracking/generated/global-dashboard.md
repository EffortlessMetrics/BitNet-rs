...
| apple-m4-dense-slm-regression | M4-SLM-REG-005 | #4198 | in_progress | none | Do not reopen the completed apple-m4, apple-m4-slm-answer, apple-m4-productization, or apple-m4-slm-performance campaigns. |
...
| nvidia-5070ti | CUDA-UX-002 | #4191 | merged | none | CUDA visibility is not kernel execution. |
