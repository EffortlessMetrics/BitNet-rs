...
| intel-258v-platform | LNL258V-GOAL-AUDIT-041 | TBD | in_progress | LNL258V-POWER-013 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | A770-028 | #362 | merged | none | OpenCL-first for native A770 proof. |
...
| nvidia-5070ti | CUDA-MODEL-017 | #335 | ready | CUDA-MODEL-018 | CUDA visibility is not kernel execution. |
...
| slm-cpu | SLM-CPU-082 | #361 | ready | none | Do not edit BitNet QK256/I2_S kernels. |
