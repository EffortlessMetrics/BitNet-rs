...
| apple-m4-dense-slm-regression | M4-SLM-REG-001 | TBD | ready | M4-SLM-REG-002 | Do not reopen the completed apple-m4, apple-m4-slm-answer, apple-m4-productization, or apple-m4-slm-performance campaigns. |
...
| apple-m4-slm-hardening | M4-SLM-HARDEN-004 | TBD | in_progress | none | Do not reopen completed Apple M4 proof, operational, SLM answer, productization, or performance campaigns. |
...
| intel-258v-platform | CPU258V-017 | #4123 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-006 | #4152 | merged | none | CUDA visibility is not kernel execution. |
