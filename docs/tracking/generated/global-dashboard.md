...
| apple-m4-inference-excellence | M4-DENSE-REF-000 | TBD | proposed | M4-DENSE-REF-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-OPENVINO-QUAL-POLICY-001 | #5639 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
