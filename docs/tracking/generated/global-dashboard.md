...
| apple-m4-local-answer | M4-QA-001 | #4618 | pr_open | M4-QA-002 | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
...
| intel-258v-platform | CPU-BITNET-PERF-002 | #4609 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
