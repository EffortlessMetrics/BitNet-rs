...
| intel-258v-platform | CPU-BITNET-PERF-001 | #4607 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-008S | #4606 | merged | none | Do not edit BitNet QK256/I2_S kernels. |
