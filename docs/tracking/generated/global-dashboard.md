...
| apple-m4-slm-performance | M4-SLM-PERF-002 | TBD | in_progress | M4-SLM-PERF-003 | Do not reopen the completed apple-m4, apple-m4-operational, apple-m4-slm-answer, or apple-m4-productization campaigns. |
...
| intel-258v-platform | CPU258V-015 | #4046 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-ANSWER-011 | #4039 | pr_open | CUDA-DENSE-001 | CUDA visibility is not kernel execution. |
