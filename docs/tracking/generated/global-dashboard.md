...
| nvidia-5070ti | CUDA-DENSE-051 | TBD | in_progress | CUDA-DENSE-052 | CUDA visibility is not kernel execution. |
| server-real-inference | SERVER-005 | #4490 | merged | none | Do not reintroduce simulated inference. |
| slm-cpu | SLM-CPU-008W | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
