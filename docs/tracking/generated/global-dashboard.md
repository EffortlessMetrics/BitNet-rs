...
| apple-m4-durable-inference-evidence | M4-DURABLE-004 | TBD | proposed | M4-DURABLE-005 | This is an M4 Mac mini evidence-refresh campaign. |
...
| intel-258v-platform | LNL258V-REG-002 | #5000 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-MODEL-008 | #5007 | pr_open | none | CUDA visibility is not kernel execution. |
