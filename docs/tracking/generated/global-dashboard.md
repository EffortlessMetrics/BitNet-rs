...
| apple-m4-slm-excellence | M4-SLM-EX-009 | TBD | ready | M4-SLM-EX-010 | This is an M4 Mac mini local campaign. |
...
| nvidia-5070ti | CUDA-DENSE-030 | TBD | in_progress | none | CUDA visibility is not kernel execution. |
