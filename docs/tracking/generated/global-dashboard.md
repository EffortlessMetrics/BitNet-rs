...
| apple-m4-inference-excellence | M4-BITNET-REG-001 | TBD | proposed | M4-BITNET-EX-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-CPU-SLM-PERF-001 | TBD | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
