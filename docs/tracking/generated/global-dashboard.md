...
| apple-m4-inference-excellence | M4-MODEL-LIFECYCLE-001 | TBD | in_progress | M4-COMPAT-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-a770 | A770-021 | #278 | merged | none | OpenCL-first for native A770 proof. |
...
| slm-cpu | SLM-CPU-079 | TBD | ready | none | Do not edit BitNet QK256/I2_S kernels. |
