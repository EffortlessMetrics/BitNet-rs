...
| intel-258v-platform | LNL258V-OP-002 | #4718 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-DENSE-054 | TBD | in_progress | CUDA-MODEL-001 | CUDA visibility is not kernel execution. |
