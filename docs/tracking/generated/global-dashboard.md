...
| apple-m4-inference-excellence | M4-REPRO-004 | #5610 | pr_open | M4-RECEIPT-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-OPENVINO-DOCS-006 | #5608 | merged | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-034 | TBD | ready | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
