...
| apple-m4-local-answer | M4-BITNET-WARM-002 | #4705 | in_progress | none | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
...
| intel-258v-platform | CPU-BITNET-REF-002 | #4710 | pr_open | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | CUDA-UX-009 | TBD | proposed | CUDA-UX-010 | CUDA visibility is not kernel execution. |
| server-real-inference | SERVER-005 | #4490 | merged | none | Do not reintroduce simulated inference. |
| slm-cpu | SLM-CPU-008Y | #4696 | blocked | none | Do not edit BitNet QK256/I2_S kernels. |
