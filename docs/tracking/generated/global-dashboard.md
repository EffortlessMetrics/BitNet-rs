...
| apple-m4-inference-excellence | M4-CANARY-001 | TBD | proposed | M4-DENSE-REF-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-OPENVINO-DOCS-002 | TBD | proposed | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | SLM-CPU-033 | TBD | in_progress | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
