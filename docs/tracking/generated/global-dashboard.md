...
| apple-m4-inference-excellence | M4-BENCH-007 | TBD | proposed | M4-ROUTE-MATRIX-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | LNL258V-PROFILE-RUN-003 | TBD | in_progress | none | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
