...
| apple-m4-slm-performance | Apple M4 SLM performance | M4-SLM-PERF-001 | Do not reopen the completed apple-m4, apple-m4-operational, apple-m4-slm-answer, or apple-m4-productization campaigns. |
...
| intel-258v-platform | Intel 258V platform validation | CPU258V-014 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-ANSWER-011 | CUDA visibility is not kernel execution. |
