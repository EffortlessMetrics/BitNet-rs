...
| apple-m4-operational | Apple M4 operational readiness | M4-OP-002 | Do not reopen the completed apple-m4 proof campaign. |
...
| intel-npu | Intel NPU validation | NPU-005 | Device-node detection is not inference. |
