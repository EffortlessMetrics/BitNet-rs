...
| intel-258v-platform | Intel 258V platform validation | CPU258V-004 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| model-artifacts | Model artifact answer authority | MODEL-ARTIFACT-007 | Do not weaken CPU, CUDA, Apple, NPU, SLM, server, or quality gates. |
