...
| intel-258v-platform | Intel 258V platform validation | LNL258V-GOAL-AUDIT-038 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | Intel Arc A770 validation | A770-028 | OpenCL-first for native A770 proof. |
...
| slm-cpu | Small dense model CPU proof | SLM-CPU-082 | Do not edit BitNet QK256/I2_S kernels. |
