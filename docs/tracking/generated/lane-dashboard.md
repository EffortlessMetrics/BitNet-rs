...
| apple-m4-local-server | Apple M4 local server | M4-SERVE-004 | This is an M4 Mac mini dense SLM service campaign. |
...
| intel-258v-platform | Intel 258V platform validation | CPU258V-026 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
