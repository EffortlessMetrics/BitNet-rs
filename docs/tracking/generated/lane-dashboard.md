...
| apple-m4-inference-excellence | Apple M4 inference excellence | M4-BENCH-006 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-GOAL-AUDIT-003 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | Small dense model CPU proof | SLM-CPU-056 | Do not edit BitNet QK256/I2_S kernels. |
