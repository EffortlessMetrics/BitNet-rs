...
| apple-m4-slm-metal-phases | Apple M4 SLM Metal phases | M4-METAL-003 | This is an M4 Mac mini dense SLM campaign. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-DENSE-040 | CUDA visibility is not kernel execution. |
