...
| apple-m4-durable-inference-evidence | Apple M4 durable inference evidence | M4-DURABLE-003 | This is an M4 Mac mini evidence-refresh campaign. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-MODEL-007 | CUDA visibility is not kernel execution. |
