...
| intel-258v-platform | Intel 258V platform validation | LNL258V-GOAL-AUDIT-010 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| slm-cpu | Small dense model CPU proof | SLM-CPU-061 | Do not edit BitNet QK256/I2_S kernels. |
