...
| intel-258v-platform | Intel 258V platform validation | SLM-OV258V-006 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-DENSE-050 | CUDA visibility is not kernel execution. |
