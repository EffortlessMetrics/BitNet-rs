...
| apple-m4-slm-hardening | Apple M4 SLM hardening | M4-SLM-HARDEN-001 | Do not reopen completed Apple M4 proof, operational, SLM answer, productization, or performance campaigns. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-PLANNER-004 | CUDA visibility is not kernel execution. |
