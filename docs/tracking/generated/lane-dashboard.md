...
| intel-258v-platform | Intel 258V platform validation | CPU258V-017 | 258V CPU input-contract proof is first priority; prompt/token authority must be audited before more Arc, NPU, or SIMD work. |
