...
| apple-m4-slm-eval-and-proof | Apple M4 dense SLM eval and proof | M4-SLM-EVAL-001 | This is an M4 Mac mini dense SLM campaign. |
...
| slm-cpu | Small dense model CPU proof | SLM-CPU-008W | Do not edit BitNet QK256/I2_S kernels. |
