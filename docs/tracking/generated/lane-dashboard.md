...
| apple-m4-slm-excellence | Apple M4 SLM excellence | M4-SLM-EX-003 | This is an M4 Mac mini local campaign. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-DENSE-027 | CUDA visibility is not kernel execution. |
