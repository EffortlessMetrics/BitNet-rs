...
| apple-m4-continuity | Apple M4 continuity | M4-CONT-004 | This is an M4 Mac mini local campaign; do not execute MacBook artifact sweeps or MacBook receipts here. |
...
| intel-258v-platform | Intel 258V platform validation | CPU258V-019 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-DENSE-024 | CUDA visibility is not kernel execution. |
