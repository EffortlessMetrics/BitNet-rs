...
| apple-m4-slm-answer | Apple M4 SLM local answer usability | SLM-M4-004 | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
...
| intel-258v-platform | Intel 258V platform validation | CPU258V-003 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| model-artifacts | Model artifact answer authority | MODEL-ARTIFACT-004 | Do not weaken CPU, CUDA, Apple, NPU, SLM, server, or quality gates. |
...
| slm-cpu | Small dense model CPU proof | SLM-CPU-005 | Do not edit BitNet QK256/I2_S kernels. |
