...
| apple-m4-dense-slm-regression | Apple M4 dense SLM regression guardrails | M4-SLM-REG-004 | Do not reopen the completed apple-m4, apple-m4-slm-answer, apple-m4-productization, or apple-m4-slm-performance campaigns. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-004 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-DENSE-008 | CUDA visibility is not kernel execution. |
