...
| apple-m4-local-answer | Apple M4 local answer usability | M4-BITNET-ASK-006 | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
...
| intel-258v-platform | Intel 258V platform validation | CPU-BITNET-PERF-003 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-UX-009 | CUDA visibility is not kernel execution. |
