...
| apple-m4-inference-excellence | Apple M4 inference excellence | M4-TREND-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-a770 | Intel Arc A770 validation | A770-021 | OpenCL-first for native A770 proof. |
...
| slm-cpu | Small dense model CPU proof | SLM-CPU-078 | Do not edit BitNet QK256/I2_S kernels. |
