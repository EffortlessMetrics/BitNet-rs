...
| apple-m4-slm-excellence | Apple M4 SLM excellence | M4-SLM-EX-007 | This is an M4 Mac mini local campaign. |
...
| intel-258v-platform | Intel 258V platform validation | CPU258V-020 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-DENSE-028 | CUDA visibility is not kernel execution. |
