...
| apple-m4-inference-excellence | Apple M4 inference excellence | M4-GATE-HYGIENE-001 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-THERMAL-001 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
