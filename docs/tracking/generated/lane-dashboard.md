...
| apple-m4-inference-excellence | Apple M4 inference excellence | M4-REPRO-002 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-OV-QUAL-002 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
