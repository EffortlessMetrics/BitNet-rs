...
| apple-m4-slm-performance | Apple M4 SLM performance | M4-SLM-PERF-006 | Do not reopen the completed apple-m4, apple-m4-operational, apple-m4-slm-answer, or apple-m4-productization campaigns. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-COMPARE-001 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | Intel Arc A770 validation | A770-003 | OpenCL-first for native A770 proof. |
| intel-npu | Intel NPU validation | NPU-009 | Device-node detection is not inference. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-PROD-004 | CUDA visibility is not kernel execution. |
