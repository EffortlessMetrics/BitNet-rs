...
| apple-m4-local-answer | Apple M4 local answer usability | M4-BITNET-ASK-001 | Do not reopen the completed apple-m4 or apple-m4-operational campaigns. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-COMPARE-005 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
