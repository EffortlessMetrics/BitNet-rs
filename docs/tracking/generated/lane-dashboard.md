...
| apple-m4-inference-excellence | Apple M4 inference excellence | M4-BITNET-EX-011 | This is an M4 Mac mini inference-excellence campaign. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-SERVER-004 | CUDA visibility is not kernel execution. |
| server-real-inference | Server real inference | SERVER-005 | Do not reintroduce simulated inference. |
| slm-cpu | Small dense model CPU proof | SLM-CPU-029 | Do not edit BitNet QK256/I2_S kernels. |
