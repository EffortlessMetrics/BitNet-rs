...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-SERVER-002 | CUDA visibility is not kernel execution. |
| server-real-inference | Server real inference | SERVER-005 | Do not reintroduce simulated inference. |
| slm-cpu | Small dense model CPU proof | SLM-CPU-011 | Do not edit BitNet QK256/I2_S kernels. |
