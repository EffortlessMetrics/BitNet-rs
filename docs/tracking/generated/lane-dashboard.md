...
| apple-m4-inference-excellence | Apple M4 inference excellence | M4-REPRO-003 | This is an M4 Mac mini inference-excellence campaign. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-INTELGPU-DOCS-001 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
| intel-a770 | Intel Arc A770 validation | A770-INTELGPU-DOCS-001 | OpenCL-first for native A770 proof. |
...
| slm-cpu | Small dense model CPU proof | SLM-CPU-027 | Do not edit BitNet QK256/I2_S kernels. |
