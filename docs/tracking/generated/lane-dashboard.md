...
| apple-m4-slm-model-breadth | Apple M4 SLM model breadth | M4-MODEL-003 | This is an M4 Mac mini dense SLM campaign. |
...
| intel-258v-platform | Intel 258V platform validation | CPU258V-025 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-DENSE-039 | CUDA visibility is not kernel execution. |
