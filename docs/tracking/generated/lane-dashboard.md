...
| apple-m4-slm-eval-and-proof | Apple M4 dense SLM eval and proof | M4-SLM-EVAL-003 | This is an M4 Mac mini dense SLM campaign. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-ASK-001 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
