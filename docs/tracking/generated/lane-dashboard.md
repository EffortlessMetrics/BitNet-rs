...
| intel-258v-platform | Intel 258V platform validation | LNL258V-NPU-RESIDENT-001 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
