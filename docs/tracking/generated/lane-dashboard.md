...
| apple-m4-slm-model-breadth | Apple M4 SLM model breadth | M4-MODEL-006 | This is an M4 Mac mini dense SLM campaign. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-DENSE-042 | CUDA visibility is not kernel execution. |
