...
| apple-m4-durable-inference-evidence | Apple M4 durable inference evidence | M4-DURABLE-004 | This is an M4 Mac mini evidence-refresh campaign. |
...
| intel-258v-platform | Intel 258V platform validation | LNL258V-REG-002 | 258V CPU proof is first priority; NPU and Arc proofs must compare against the 258V CPU reference before BitNet-adjacent parity claims. |
...
| nvidia-5070ti | NVIDIA RTX 5070 Ti validation | CUDA-MODEL-008 | CUDA visibility is not kernel execution. |
