...
| `dense_qwen3_06b_q8_candidate` | Exact-profile server readiness is promoted by `ci/hardware/windows-9950x3d-rtx5070ti/2026-05-19/server-strict-dense-qwen3-q8-smoke.json`; repeated same-artifact comparator evidence remains required before speed or benchmark-qualified claims. |
