...
**Need help?** Join our [Discord community](https://discord.gg/bitnet-rust) or check the [troubleshooting guide](./troubleshoot-common-issues.md) for more assistance with cross-validation setup.