...
| SmolLM2 360M | structurally valid artifact contract; strict CPU preflight blocked before tokenizer/prompt/generation | `ci/slm-cpu/windows-9950x3d-rtx5070ti/2026-05-15/smollm2-360m-strict-cpu-preflight-blocker.json` | resolve strict loader/model-family normalization policy or governed exception before CPU sanity, all-layer planning, or CUDA |
